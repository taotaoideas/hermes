...
<jsp:useBean id="navBar" class="com.ctrip.hermes.container.view.NavigationBar" scope="page" />

<!DOCTYPE html>
<html lang="en">

<head>
	<title>Container - ${model.page.description}</title>
...
<body data-spy="scroll" data-target=".subnav" data-offset="50">
	...
	<div class="container-fluid" style="min-height:524px;">
		...
		<br />
		<div class="container">
			<footer><center>&copy;2013 Dianping Container Team</center></footer>
		</div>
	</div>
	<!--/.fluid-container-->
