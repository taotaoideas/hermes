...
public class AvroVisitEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.ctrip.hermes.avro.AvroVisitEvent.Builder newBuilder() {
    return new com.ctrip.hermes.avro.AvroVisitEvent.Builder();
  }
  
  /** Creates a new AvroVisitEvent RecordBuilder by copying an existing Builder */
  public static com.ctrip.hermes.avro.AvroVisitEvent.Builder newBuilder(com.ctrip.hermes.avro.AvroVisitEvent.Builder other) {
    return new com.ctrip.hermes.avro.AvroVisitEvent.Builder(other);
  }
  
  /** Creates a new AvroVisitEvent RecordBuilder by copying an existing AvroVisitEvent instance */
  public static com.ctrip.hermes.avro.AvroVisitEvent.Builder newBuilder(com.ctrip.hermes.avro.AvroVisitEvent other) {
    return new com.ctrip.hermes.avro.AvroVisitEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroVisitEvent>
    ...
    private Builder() {
      super(com.ctrip.hermes.avro.AvroVisitEvent.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.ctrip.hermes.avro.AvroVisitEvent.Builder other) {
      super(other);
    ...
    private Builder(com.ctrip.hermes.avro.AvroVisitEvent other) {
            super(com.ctrip.hermes.avro.AvroVisitEvent.SCHEMA$);
      if (isValidValue(fields()[0], other.ip)) {
        this.ip = data().deepCopy(fields()[0].schema(), other.ip);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'ip' field */
    public com.ctrip.hermes.avro.AvroVisitEvent.Builder setIp(java.lang.CharSequence value) {
    ...
    public com.ctrip.hermes.avro.AvroVisitEvent.Builder clearIp() {
      ip = null;
    ...
    /** Sets the value of the 'url' field */
    public com.ctrip.hermes.avro.AvroVisitEvent.Builder setUrl(java.lang.CharSequence value) {
    ...
    public com.ctrip.hermes.avro.AvroVisitEvent.Builder clearUrl() {
      url = null;
    ...
    /** Sets the value of the 'tz' field */
    public com.ctrip.hermes.avro.AvroVisitEvent.Builder setTz(long value) {
    ...
    public com.ctrip.hermes.avro.AvroVisitEvent.Builder clearTz() {
